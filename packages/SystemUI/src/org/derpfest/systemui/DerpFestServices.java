...
@SysUISingleton
public class DerpFestServices extends VendorServices {
    ...
    @Inject
    public DerpFestServices(Context context, UiEventLogger uiEventLogger, Lazy<ServiceConfigurationGoogle> serviceConfigurationGoogle, Lazy<ColumbusServiceWrapper> columbusService) {
        super(context);
