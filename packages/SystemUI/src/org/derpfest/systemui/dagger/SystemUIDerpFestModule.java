...
import static org.derpfest.systemui.Dependency.*;
...
public abstract class SystemUIDerpFestModule {
    ...
    @Binds
    abstract ThemeOverlayController provideThemeOverlayController(ThemeOverlayControllerDerpFest themeOverlayController);
